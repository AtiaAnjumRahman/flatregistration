<?php  
  require 'controller/search_control.php'
?>
...
<html lang="en">
  <head>
    ...
    <link href="view/assets/css/rent.css" rel="stylesheet">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">B-Flat</a>
            ...
            <?php 
              if(empty($_SESSION['username'])){
                echo '<li class="nav-item">';
                  echo '<a class="nav-link" href="./view/auth/login.php">Login</a>';
                echo '</li>';
              }else{
                echo '<li class="nav-item">';
                 echo '<a class="nav-link" href="./view/auth/dashboard.php">Home</a>';
               echo '</li>';
              }
            ?>
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Welcome To Flat Rental Registration!</div>
                         ...
                         echo   '<div class="row">
                            ...
                            <h4 class="text-center">Owner Details</h4>';
                              ...
                              if ($value['image'] !== 'uploads/') {
                                # code...
                                echo '<img src="view/app/'.$value['image'].'" width="100">';
                              }
    ...
    <!-- Plugin JavaScript -->
    <script src="view/assets/plugins/jquery-easing/jquery.easing.min.js"></script>

    <!-- Contact form JavaScript -->
    <script src="view/assets/js/jqBootstrapValidation.js"></script>
    <script src="view/assets/js/contact_me.js"></script>

    <!-- Custom scripts for this template -->
    <script src="view/assets/js/rent.js"></script>
  </body>
</html>
